...
Private Sub ApplyPrintSettingsToSheet(ws As Worksheet, ByVal isLandscape As Boolean)
    ...
    ' Center on page: Horizontal saja
    ...
    Else
        ' kalau gagal deteksi, abaikan (biarkan default)
        ws.PageSetup.PrintArea = ""
    End If
End Sub

' === Macro 1: hanya set print settings untuk semua file di folder ===
Public Sub BatchSetPrintSettings()
    ...
    ' Pilih folder yang berisi file Excel
    ...
    Do While fName <> ""
        ' Jangan proses workbook macro ini sendiri kalau di folder yang sama
        If ThisWorkbook.FullName <> folderPath & fName Then
            Set wb = Workbooks.Open(folderPath & fName, UpdateLinks:=False)
            
            ' Atur sampai 4 sheet pertama (atau kurang kalau sheet-nya <4)
            ...
            For i = 1 To maxSheets
                ...
                ' Sheet 1,3,4 Landscape; Sheet 2 Portrait
                If i = 2 Then
                    ApplyPrintSettingsToSheet ws, False   ' Portrait
                Else
                    ApplyPrintSettingsToSheet ws, True  ' Landscape
                End If
            Next i
    ...
    MsgBox "Selesai memperbarui pengaturan print untuk semua file di folder:" & vbCrLf & _
           folderPath, vbInformation
End Sub

' === Macro 2: set print settings + export ke PDF untuk setiap file ===
Public Sub BatchSetPrintSettingsAndPDF()
    Dim folderPath As String
    ...
    ' Buat subfolder PDF jika belum ada
    ...
    Do While fName <> ""
        ...
        If ThisWorkbook.FullName <> folderPath & fName Then
            ...
            ' Tentukan nama file PDF: sama dengan nama Excel, beda ekstensi
            If InStrRev(fName, ".") > 0 Then
                pdfName = Left(fName, InStrRev(fName, ".") - 1) & ".pdf"
            Else
                pdfName = fName & ".pdf"
            End If
            
            ' Export seluruh workbook ke PDF
            On Error Resume Next
            wb.ExportAsFixedFormat Type:=xlTypePDF, _
                                   Filename:=pdfFolderPath & pdfName, _
    ...
    MsgBox "Selesai set print settings dan ekspor PDF." & vbCrLf & _
           "Folder Excel : " & folderPath & vbCrLf & _
           "Folder PDF   : " & pdfFolderPath, vbInformation
End Sub
